...
export default function Seo() {
  ...
  const form = useForm<InsertSeoConfig>({
    ...
    defaultValues: seoConfig || {
      ...
      descricao: "Sistema COMPLETO que organiza sua locadora, DOBRA receita, elimina inadimplência e automatiza contratos profissionais. 50+ locadoras já usam. 15 dias GRÁTIS!",
          ...
          <div className="bg-green-100 dark:bg-green-900 border-2 border-green-500 p-6 rounded-lg text-center">
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-4 mb-4">
              <div className="bg-white dark:bg-gray-800 p-4 rounded-lg">
                <div className="text-2xl font-bold text-green-600">7 DIAS</div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
              <div className="bg-white dark:bg-gray-800 p-4 rounded-lg border">
                ...
                <p className="text-xs text-gray-600 dark:text-gray-400 italic">
                  "Sistema COMPLETO que organiza sua locadora, DOBRA receita, elimina inadimplência e automatiza contratos profissionais. 50+ locadoras já usam. 15 dias GRÁTIS!"
                </p>
              </div>
              <div className="bg-white dark:bg-gray-800 p-4 rounded-lg border">
                <h4 className="font-bold text-sm text-purple-700 dark:text-purple-300 mb-2">💼 FOCO NA PROFISSIONALIZAÇÃO:</h4>
                <p className="text-xs text-gray-600 dark:text-gray-400 italic">
                  "Transforme sua locadora em empresa profissional! Sistema automatiza contratos, organiza finanças e dobra receita em 90 dias. Teste 15 dias GRÁTIS!"
                </p>
              </div>
              <div className="bg-white dark:bg-gray-800 p-4 rounded-lg border">
                <h4 className="font-bold text-sm text-blue-700 dark:text-blue-300 mb-2">⚡ FOCO NA ORGANIZAÇÃO:</h4>
                <p className="text-xs text-gray-600 dark:text-gray-400 italic">
                  "Organize sua locadora com sistema completo! Contratos automáticos, controle financeiro total e zero inadimplência. 50+ empresas confiam. Teste 15 dias grátis!"
                </p>
              </div>
              <div className="bg-white dark:bg-gray-800 p-4 rounded-lg border">
                <h4 className="font-bold text-sm text-orange-700 dark:text-orange-300 mb-2">📈 FOCO EM RESULTADOS:</h4>
                <p className="text-xs text-gray-600 dark:text-gray-400 italic">
                  "Locadoras aumentam 60% da receita em 3 meses! Sistema elimina planilhas, gera contratos válidos e automatiza gestão completa. 15 dias GRÁTIS!"
                </p>
              </div>
            </div>
          </CardContent>
