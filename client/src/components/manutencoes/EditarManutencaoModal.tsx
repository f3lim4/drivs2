      ...
      <DialogContent className="sm:max-w-[680px] md:max-w-3xl lg:max-w-4xl xl:max-w-[1000px] max-h-[90vh] overflow-y-auto p-0">
        ...
        <form onSubmit={form.handleSubmit(onSubmit)} className="flex flex-col h-full">
          <div className="flex-1 px-8 pb-4 space-y-8 overflow-y-auto">
            ...
            <div className="space-y-4">
              <div>
                <h3 className="text-lg font-semibold text-gray-900">Valores e Progresso</h3>
                <p className="text-sm text-gray-600">Informações financeiras e de execução</p>
              </div>
              <div className="grid grid-cols-12 gap-6">
                <div className="col-span-12 md:col-span-4 space-y-2">
            ...
            <div className="space-y-4">
              <div>
                <h3 className="text-lg font-semibold text-gray-900">Quilometragem e Status</h3>
                <p className="text-sm text-gray-600">Informações de quilometragem e status do serviço</p>
              </div>
              <div className="grid grid-cols-12 gap-6">
                <div className="col-span-12 md:col-span-4 space-y-2">
            ...
            <div className="space-y-4">
              <div>
                ...
                <p className="text-sm text-gray-600">Informações complementares da manutenção</p>
              </div>
              <div className="grid grid-cols-12 gap-6">
                <div className="col-span-12 space-y-2">
            ...
            <div className="space-y-4">
              <div>
                ...
                <p className="text-sm text-gray-600">Status e forma de pagamento da manutenção</p>
              </div>
              <div className="grid grid-cols-12 gap-6">
                <div className="col-span-12 md:col-span-6 space-y-2">
